...
standard_field_aliases = (
	...
	('existing_bib',
		('ExistingBib','Existing Bib','SeasonBib','Season Bib','SeasonsBib','Seasons Bib',),
		"Existing Bib number",
	),
	('paid',
		('Paid','Fee Paid',),
	...
	('existing_tag',
		('Existing Tag','ExistingTag','Season Tag','SeasonTag','Seasons Tag','SeasonsTag',),
		"Existing Tag",
	),
	('existing_tag2',
		('Existing Tag2','ExistingTag2','Season Tag2','SeasonTag2','Seasons Tag2','SeasonsTag2',),
		"Existing Tag2",
	),
	('note',
		('Note',),
	...
	('category_code',
		('Category','Category Code','category_name','Category Name'),
		"Category Code",
	),
	('est_kmh',
		('Est kmh','Est. kmh','kmh',),
	...
	('points',
		('Points','Rider Points', 'Pnts', 'Pts', 'Eligible Pnts', 'Eligible Pts'),
