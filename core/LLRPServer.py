...
if __name__ == '__main__':
	...
	parser.add_argument('--rfid_receiver_sensitivity', type=int, help='RFID Receiver Sensitivity: min = 0', nargs='?', default=0)
	...
	runServer(
		host=args.host,
		llrp_host=args.rfid_reader_host,
		transmitPower=args.rfid_transmit_power,
		receiverSensitivity=args.rfid_receiver_sensitivity,
	)
