# Generated by Django 2.1.7 on 2019-05-10 13:19
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('group_size_gap', core.DurationField.DurationField(default=5*60, verbose_name='Group Size Gap')),
                ('competition', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='core.Competition')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('range_str', models.CharField(blank=True, default='', max_length=120, verbose_name='Ranges')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('finish_time', core.DurationField.DurationField(blank=True, null=True, verbose_name='Finish Time')),
                ('adjustment_time', core.DurationField.DurationField(blank=True, default=0*60, null=True, verbose_name='Adjustment Time')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('start_offset', core.DurationField.DurationField(default=0*60, verbose_name='Start Offset')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('rank_categories_together', models.BooleanField(default=False, help_text='If False, Categories in the Wave will be ranked seperately.  If True, all Categories in the Wave will be ranked together.', verbose_name='Rank Categories Together')),
                ('sequence', models.PositiveSmallIntegerField(default=0, verbose_name='Sequence')),
                ('gap_before_wave', core.DurationField.DurationField(default=5*60, verbose_name='Gap Before Wave')),
                ('regular_start_gap', core.DurationField.DurationField(default=1*60, verbose_name='Regular Start Gap')),
                ('fastest_participants_start_gap', core.DurationField.DurationField(default=2*60, verbose_name='Fastest Participants Start Gap')),
        ...
        migrations.AddField(
            ...
            name='license_holder',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='core.LicenseHolder'),
        ),
        migrations.AddField(
            model_name='licensecheckstate',
            name='report_label_license_check',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='core.ReportLabel'),
        ),
        migrations.AddField(
            model_name='entrytt',
            name='event',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='core.EventTT', verbose_name='Event'),
        ),
        migrations.AddField(
            model_name='entrytt',
            name='participant',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='core.Participant', verbose_name='Participant'),
        ),
        migrations.AddField(
            model_name='customcategorytt',
            name='event',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='core.EventTT', verbose_name='EventTT'),
        ),
        migrations.AddField(
            model_name='customcategorymassstart',
            name='event',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='core.EventMassStart', verbose_name='EventMassSart'),
        ),
        migrations.AddField(
        ...
        migrations.AddField(
            ...
            name='discipline',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='core.Discipline'),
        ),
        migrations.AddField(
            model_name='categoryhint',
            name='license_holder',
        ...
        migrations.AlterIndexTogether(
            name='participantoption',
            index_together={('competition', 'participant', 'option_id'), ('competition', 'participant'), ('competition', 'option_id')},
        ),
        migrations.AlterUniqueTogether(
            name='participant',
            unique_together={('competition', 'category', 'bib'), ('competition', 'category', 'license_holder'), ('competition', 'category', 'tag2'), ('competition', 'category', 'tag')},
        ),
        migrations.AlterUniqueTogether(
            name='entrytt',
