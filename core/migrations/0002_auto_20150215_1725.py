    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('gap_before_wave', core.DurationField.DurationField(default=300, verbose_name='Gap Before Wave (GBW)')),
                ('regular_start_gap', core.DurationField.DurationField(default=60, verbose_name='Regular Start Gap (RSG)')),
