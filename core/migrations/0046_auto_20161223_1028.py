# -*- coding: utf-8 -*-
# Generated by Django 1.9.9 on 2016-12-23 15:28
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('status', models.PositiveSmallIntegerField(choices=[(0, b'Finisher'), (1, b'PUL'), (2, b'OTB'), (3, b'DNF'), (4, b'DQ'), (5, b'DNS'), (6, b'NP')], default=0, verbose_name='Status')),
                ...
                ('category_gap', models.CharField(blank=True, default=b'', max_length=8)),
                ...
                ('wave_gap', models.CharField(blank=True, default=b'', max_length=8)),
                ('finish_time', core.DurationField.DurationField(blank=True, null=True, verbose_name='Finish Time')),
                ('adjustment_time', core.DurationField.DurationField(blank=True, default=0, null=True, verbose_name='Adjustment Time')),
                ('adjustment_note', models.CharField(blank=True, default=b'', max_length=128, verbose_name='Adjustment Note')),
