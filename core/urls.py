...
urlpatterns = [
	...
	re_path(r'^.*LicenseHoldersSelectDuplicates/(?P<duplicateIds>[0123456789,]+)/$', views.LicenseHoldersSelectDuplicates),
	re_path(r'^.*LicenseHoldersSelectMergeDuplicate/(?P<duplicateIds>[0123456789,]+)/$', views.LicenseHoldersSelectMergeDuplicate),
	re_path(r'^.*LicenseHoldersMergeDuplicates/(?P<mergeId>\d+)/(?P<duplicateIds>[0123456789,]+)/$', views.LicenseHoldersMergeDuplicates),
	re_path(r'^.*LicenseHoldersMergeDuplicatesOK/(?P<mergeId>\d+)/(?P<duplicateIds>[0123456789,]+)/$', views.LicenseHoldersMergeDuplicatesOK),
